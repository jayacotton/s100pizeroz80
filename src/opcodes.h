...
OPCODES OpCodeList[] = {
    ...
    { 0x06, "LD   B,", "-", "RLC  (HL)", "RLC  (IY+0)", "MOS_FILE" },
    ...
    { 0x0E, "LD   C,", "-", " RRC  (HL)", "RRC  (IY+0)", "MOS_FF0E" },
    { 0x0F, "RRCA", "-", " RRC  A", "rrc (iy+0)->a", "MOS_FF0F" },
    { 0x10, "DJNZ ", "-", " RL   B", "rl  (iy+0)->b", "-" },
    ...
    { 0x16, "LD   D,", "-", " RL   (HL)", "RL   (IY+0)", "-" },
    { 0x17, "RLA", "-", " RL   A", "rl  (iy+0)->a", "-" },
    { 0x18, "JR   ", "-", " RR   B", "rr  (iy+0)->b", "-" },
    ...
    { 0x1E, "LD   E,", "-", " RR   (HL)", "RR   (IY+0)", "-" },
    { 0x1F, "RRA", "-", " RR   A", "rr  (iy+0)->a", "-" },
    { 0x20, "JR   NZ,", "-", " SLA  B", "sla (iy+0)->b", "-" },
    { 0x21, "LD   HL,", " LD   IX,", " SLA  C", "sla (iy+0)->c",
     "-" },
    ...
    { 0x26, "LD   H,", " LD   IXH,", " SLA  (HL)", "SLA  (IY+0)",
     "-" },
    { 0x27, "DAA", "-", " SLA  A", "sla (iy+0)->a", "-" },
    { 0x28, "JR   Z,", "-", " SRA  B", "sra (iy+0)->b", "-" },
    ...
    { 0x2E, "LD   L,", " LD   IXL,&00", " SRA  (HL)", "SRA  (IY+0)",
     "-" },
    { 0x2F, "CPL", "-", " SRA  A", "sra (iy+0)->a", "-" },
    { 0x30, "JR   NC,", "-", " SLS  B", "sls (iy+0)->b", "-" },
    ...
    { 0x36, "LD   (HL),", " LD  (IX+0),&00", " SLS  (HL)",
     "SLS  (IY+0)", "-" },
    { 0x37, "SCF", "-", " SLS  A", "sls (iy+0)->a", "-" },
    { 0x38, "JR   C,", "-", " SRL  B", "srl (iy+0)->b", "-" },
    ...
    { 0xC6, "ADD  A,", "-", " SET  0,(HL)", "SET  0,(IY+0)", "-" },
    { 0xC7, "RST  ", "-", " SET  0,A", "set 0,(iy+0)->a", "-" },
    ...
    { 0xE6, "AND  ", "-", " SET  4,(HL)", "SET  4,(IY+0)", "-" },
    { 0xE7, "RST  ", "-", " SET  4,A", "set 4,(iy+0)->a", "-" },
    ...
    { 0xEE, "XOR  ", "-", " SET  5,(HL)", "SET  5,(IY+0)", "-" },
    { 0xEF, "RST  ", "-", " SET  5,A", "set 5,(iy+0)->a", "-" },
    ...
    { 0xF6, "OR   ", "-", " SET  6,(HL)", "SET  6,(IY+0)", "-" },
    { 0xF7, "RST  ", "-", " SET  6,A", "set 6,(iy+0)->a", "-" },
    ...
    { 0xFE, "CP   ", "-", " SET  7,(HL)", "SET  7,(IY+0)", "[z80]" },
    { 0xff, "RST  ", "-", "SET  7,A", "set 7,(iy+0)->a", "ED_DOS" }
};
